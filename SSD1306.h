...
#define SSD1306_LCDWIDTH 64 ///< DEPRECATED: width w/SSD1306_128_64 defined
#define SSD1306_LCDHEIGHT 32 ///< DEPRECATED: height w/SSD1306_128_64 defined
#endif
#if defined SSD1306_128_16
#define SSD1306_LCDWIDTH 128 ///< DEPRECATED: width w/SSD1306_128_64 defined
#define SSD1306_LCDHEIGHT 16 ///< DEPRECATED: height w/SSD1306_128_64 defined
#endif
...
*/
class SSD1306 : public lowGFX {
public:
  // NEW CONSTRUCTORS -- recommended for new projects
  SSD1306(uint8_t w, uint8_t h, TwoWire *twi = &Wire,
                   int8_t rst_pin = -1, uint32_t clkDuring = 400000UL,
                   uint32_t clkAfter = 400000UL);
  // DEPRECATED CONSTRUCTORS - for back compatibility, avoid in new projects
  SSD1306(int8_t rst_pin = -1);
  ...
  void display(uint8_t addr);
  void clearDisplay(void);
  void invertDisplay(bool i);
  void dim(bool dim);
  void drawPixel(int16_t x, int16_t y, uint16_t color);
  void ssd1306_command(uint8_t c, uint8_t addr);
  bool getPixel(int16_t x, int16_t y);
  uint8_t *getBuffer(void);

protected:
  void ssd1306_command1(uint8_t c);
  void ssd1306_commandList(const uint8_t *c, uint8_t n, uint8_t addr);
